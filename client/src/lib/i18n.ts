...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "today.hideNudge": { en: "Hide", zh: "收起" },
  "today.whatsNext": { en: "Got it, what's next?", zh: "知道了，下一步？" },
  "today.nudgeComplete": { en: "You're 60% there — the hard part's done. Now just execute!", zh: "已经完成60%了——难的部分搞定了，去执行吧！" },
  "today.nudgeOf": { en: "of", zh: "/" },
