...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "onboarding.declutter": { en: "Declutter", zh: "整理" },
  "onboarding.yourMind": { en: "your mind.", zh: "你的思绪。" },
  "onboarding.desc": { en: "BrainDump helps you capture thoughts instantly and uses AI to sort them into actionable tasks based on what actually matters to you.", zh: "BrainDump 帮助你即时捕捉想法，并使用 AI 根据你真正在意的事情将它们分类为可执行的任务。" },
