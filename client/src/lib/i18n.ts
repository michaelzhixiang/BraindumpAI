...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "today.guiltFreeTime": { en: "Guilt-Free Screen Time", zh: "无负罪感屏幕时间" },
  ...
  "today.addMore": { en: "Add More", zh: "添加更多" },
  ...
  "onboarding.feature4.desc": { en: "Complete tasks, earn guilt-free screen time. +10 minutes for every task you finish.", zh: "完成任务，赢得无负罪感的屏幕时间。每完成一个任务 +10 分钟。" },
