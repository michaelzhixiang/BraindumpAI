...
export const insertTaskSchema = createInsertSchema(tasks).omit({ id: true, createdAt: true, completedAt: true, nudge: true });
...
export type UpdateTaskRequest = Partial<InsertTask> & { status?: "pending" | "completed", nudge?: string };
